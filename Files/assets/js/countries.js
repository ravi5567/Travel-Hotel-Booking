...
function populateCountries(countryElementId, stateElementId){
	...
	if(countryElement){
		...
		countryElement.options[0] = new Option('Any Worldwide City or Airport','-1');
...
$( document ).ready(function() {
    ...
    populateCountries("country3", "state");
}if($("#country4")){
    populateCountries("country4", "state");
}if($("#country5")){
    populateCountries("country5", "state");
}if($("#country6")){
    populateCountries("country6", "state");
}if($("#country7")){
    populateCountries("country7", "state");
}if($("#country8")){
    populateCountries("country8", "state");
}if($("#country9")){
    populateCountries("country9", "state");
}if($("#country14")){
    populateCountries("country14", "state");
}
if($("#country15")){
    populateCountries("country14", "state");
}
